    ...
    <body>
        ...
        <!-- main -->
            <div class="container d-flex flex-column align-items-center my-4 py-3">
                <h1>Datos provistos incorrectos</h1>
                <p>Por favor ingrese un correo y/o DNI válidos.</p>
                <a href="registrar.php"><button class="btn btn-success btn-block btne">Volver a Registrarse</button></a>
            </div>
        <!-- /main -->
