    ...
    <body>
        ...
        <main>
            <div class="container d-flex flex-column align-items-center my-4 py-3">
                <h1 class="pb-2">Gracias por contactarse con nosotros.</h1>
                <p>Su mensaje ha sido enviado correctamente.</p> 
                <a href="index.html" target="_self"><button class="btn btn-success btn-block btne">Volver al Inicio</button></a>
            </div>
        </main>    
